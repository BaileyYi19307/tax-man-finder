...
| Architecture decision records | [../architecture/decisions.md](../architecture/decisions.md) (index); numbered ADRs under [../architecture/decisions/](../architecture/decisions/) |
